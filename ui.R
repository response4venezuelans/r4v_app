  ...
  dashboardBody(
    ...
    tabsetPanel(
      tabPanel(title = "1.Data Upload",br(),
               p("V2.1 Updated 28/08/2021, please send any comments to the Regional platform IM team", style="color: #fff; background-color: #672D53"),
      ...
      tabPanel(title = "3.Consolidated report",br(),
               ...
               fluidRow(
                 ...
                 column(8,shinydashboard::box(id="box_5", title = "Consolidated Report creation", solidHeader = T,collapsible = T,collapsed = F,
                                              width = 12,status = "primary",
                                              ...
                                              p("Filter by appealing organisation if needed"),
                                              selectInput("org",label = "Appealing Organisation",choices = c("NULL")),
                 ...
                 column(4,shinydashboard::box(id="box_3", title = "Summary", solidHeader = T,collapsible = T,collapsed = F,
                                              width = 12,status = "warning",
                                              p("Total reached"),
                                              h2(textOutput("reachedorg")))),
               ),
               
               
               fluidRow(  column(12,shinydashboard::box(id="box_14", title = "Reached per Country and Sector", solidHeader = T,collapsible = T,collapsed = F,
                                                        width = 12,status = "primary",
                                                        fluidRow(  column(6,plotlyOutput("plotorg")),
                                                                   column(6,plotlyOutput("plotorg2"))
